...
const ServerComponentAndServerAction = () => {
	return (
		<div>
			<textarea>
				في Next.js، هناك مفهومان رئيسيان للتعامل مع البيانات وتنفيذ العمليات على الخادم: مكونات الخادم (Server Components) وإجراءات الخادم
			...
			<textarea>
				باختصار: مكونات الخادم تُستخدم لعرض المحتوى الذي يُعالج على الخادم، مما يُقلل من حجم JavaScript على العميل ويحسّن الأداء. من ناحية
